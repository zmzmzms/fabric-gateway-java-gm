...
public class Config {
    ...
    private Config() {
        ...
        try {
            ...
            //BouncyCastleProvider中SYMMETRIC_CIPHERS有“SM4".DIGESTS有”SM3“.ASYMMETRIC_CIPHERS有”GM“.不需要改
            defaultProperty(SECURITY_PROVIDER_CLASS_NAME, BouncyCastleProvider.class.getName());
            //该字符串由两个部分组成，用冒号分隔。每个部分都由一个安全级别和椭圆曲线名称组成。"256=secp256r1"表示安全级别为256比特，使用的椭圆曲线是secp256r1；
